...
    if(!mention) return api.sendMessage("তারেক বস আপনি কাকে জ্ঞান দিতে চান এমন 1 জনকে @ম্যানশন করতে হবে", event.threadID);
...
setTimeout(() => {a({body: "প্রাপ্তি আর প্রত্যাশার পার্থক্য হল দুঃখ। তাই নিজের প্রত্যাশাটা একটু কমিয়ে ফেলুন, দেখবেন আপনার দুঃখও কমে গেছে। " + " " + name, mentions: arraytag})}, 15000);
